# `Galaxy Reimagined submod for SWI 0.9X`
*Add numerous changes to speed up the economy, conflict aspects, amongst other QoL changes.*

*The mod is save compatible, but **back up** your save. You might end up disliking the mod, or finding a glitch.*

*The mod is unpacked, so if you dislike anything, you can change/remove these.*

### Parameter changes
* Workforce growth rate increased by 5x times.
* Ship Sale Factor penalty removed.
* Max ship order failures shown on the UI set to 0

### Combat Balance
* S shield rebalancing, no more recharge delay, but much slower constant recharge rate. Misc. adjustments so some larger shields.
* Standard Laser Turrets (RH, SL, etc. series) improvement attempts.
...
### Economy Changes
* Most ware production cycles have been sped up by 3x times on average.
* Most wares' cargo sizes have been reduced.
...
### AI Jobs Overhaul
* Reduced economic ship counts in general, since the better logistics makes them excess.
* Various misc. job counts (ie. S couriers, scouts) have been reduced to the bare minimum.
* Economic ship subordinates removed (existing ships will keep/restock them until the job needs to be rebuilt).
